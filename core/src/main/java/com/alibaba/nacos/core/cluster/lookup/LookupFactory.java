...
public final class LookupFactory {
    ...
    private static LookupType chooseLookup(String lookupType) {
        ...
        InputStream resourceAsStream = LookupFactory.class.getClassLoader().getResourceAsStream("cluster.conf");
        if (resourceAsStream != null || StringUtils.isNotBlank(EnvUtil.getMemberList())) {
