...
public class RaftCore implements Closeable {
    ...
    public static final String API_DEL = UtilsAndCommons.NACOS_NAMING_CONTEXT + "/raft/datum/delete";
    ...
    public static final String API_ON_DEL = UtilsAndCommons.NACOS_NAMING_CONTEXT + "/raft/datum/commit/delete";
    ...
    public void signalDelete(final String key) throws Exception {
        ...
        try {
            ...
            if (!isLeader()) {
                ...
                raftProxy.proxy(getLeader().ip, API_DEL, params, HttpMethod.POST);
                return;
            }
            ...
            for (final String server : peers.allServersWithoutMySelf()) {
                ...
                HttpClient.asyncHttpPostLarge(url, null, json.toString(), new Callback<String>() {
                    @Override
                    public void onReceive(RestResult<String> result) {
                        if (!result.ok()) {
                            Loggers.RAFT
